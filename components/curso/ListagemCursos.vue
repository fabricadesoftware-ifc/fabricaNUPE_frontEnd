<!-- BOT SUPERIOR
 ...
 <template>
  <section>
    ...
    <div class="block">
      <br />Ordenar:
      <b-radio v-model="radio" name="name" native-value="curso">
        Por nome
      </b-radio>
      <b-radio v-model="radio" name="name" native-value="codigo">
        Por código
      </b-radio>
    </div>
  </section>
...
<template>
  <div>
    ...
    <h2 class="subtitle">Todos os Cursos</h2>
    ...
    <div class="level">
      <span class="level-left">
        <b-input
          ...
          icon="magnify"
          icon-clickable
          placeholder="Pesquise-os na lista."
        />
      </span>
...
export default {
  ...
  methods: {
    ...
    editSector(){
       this.$router.push({ path: 'editarCurso' })
    },
    confirmCustomDelete() {
      this.$buefy.dialog.confirm({
        title: "Excluir Aluno",
