  ...
  <div>
    <div class="columns is-vcentered">
      ...
      <div class="column has-text-centered">
        ...
        <form @submit="createAttendanceReason()">
          <b-field label="Razão do atendimento" :label-position="labelPosition">
            <b-input
              type="text"
              placeholder="Digite um nome ao resgistro"
              v-model="name"
              required
            >
            </b-input>
          ...
          <b-field label="Razão Pai" :label-position="labelPosition">
            <b-input type="number" v-model="father_reason" placeholder="Número">
            </b-input>
          </b-field>
    ...
    async createAttendanceReason() {
      try {
        ...
        this.$buefy.toast.open({
          message: "Razão de atendimento criador com sucesso.",
          type: "is-primary",
        });
        // this.$emit("createAttendanceReason");
      } catch (err) {
        this.$buefy.toast.open({
          message: "Erro ao criar o razão de atendimento!",
          type: "is-danger",
        });
        console.log(err);
      }
